  ...
  <h5 class="border-bottom mb-10">
    ...
    <h5 class="border-bottom mb-10">
      ...
      @elseif(Helpers::getAccountStatus($account->id) == 1)
       <span title="What does 'Locked' mean?" data-toggle="popover" data-trigger="hover" data-content="The acount is locked, which means only the last IP ({{ $account->last_ip }}) can log in." class="float-right status Locked">Locked (Hover)</span>
